                        ...
                        <Row className="align-items-center">
                            <Col lg={6}>
                                <div className="hero-title pr-lg-5">
                                    <p className="text-uppercase text-primary font-weight-medium f-14 mb-4">Cretivity + Innovation</p>
                                    <h1 className="hero-1-title mb-4 font-weight-normal line-height-1_4">Get Your Professional Website Done With <span className="text-primary font-weight-medium">SoftwareDads</span></h1>
